  ...
  module CLI
    module Commands
      class Interactive < Dry::CLI::Command
        ...
        QUESTION_BANK = {
          serial: UNIVERSAL_QUESTIONS,

          mpi: UNIVERSAL_QUESTIONS.merge(
        ...
        def output_file_question(key, question, flags, pastel, prompt)
          ...
          puts pastel.bold.yellow("\nOutput File\n")
          puts "Th output file contains all output generated by your script. e.g. A script with the command #{pastel.yellow('echo')} 'Hello, world!', will produce an output file comtaining 'Hello, world'.\nWhat you would like to name the outut file? If left blank, it will default to #{flags[:job_name]}.out.\n\n"
